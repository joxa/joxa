...
symbol_test() ->
    ...
    ?memo(?assertMatch({{quote,{ident,'Hello?',{1,2}},{1,1}},
                        <<>>,
                        {1,8}},
                       joxa.compiler:symbol(<<":Hello?">>, index()))),
    ?memo(?assertMatch({{quote,{ident,boo88,{1,2}},{1,1}},<<>>,{1,7}},
    ...
    ?memo(?assertMatch({fail,{expected,{string,<<":">>},{1,1}}},
                       joxa.compiler:symbol(<<"bock[">>, index()))),
    ?memo(?assertMatch({{quote,{ident,bock,{1,2}},{1,1}},
                        <<"(ee">>,
                        {1,6}},
...
value_test() ->
    ...
    ?memo(?assertMatch({{quote,{ident,boo88,{1,2}},{1,1}},<<>>,{1,7}},
                       joxa.compiler:value(<<":boo88">>, index()))),
    ?memo(?assertMatch({{ident,bock,{1,1}},<<":">>,{1,5}},
                       joxa.compiler:value(<<"bock:">>, index()))),
    ?memo(?assertMatch({{quote,{ident,bock,{1,2}},{1,1}},
                        <<"(ee">>,
                        {1,6}},
